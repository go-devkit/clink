...
// [WithLocalCommand] and [WithLocalFallback], or [WithLocalCommandTree] and
// [WithLocalFallbackTree] for a command tree that carries its own name), client
// signals, and terminal resizes.
//
